...
1068797    .       .       .       .       .
```
In the above example, bus ID 1 departs at timestamp 1 (seven minutes after t). This is fine; the only requirement on that minute is that bus ID 19 departs then, and it does.
...
Your puzzle input is `215694783`.
